...
function esitaPildid(){   //funktsiooni algus
    ...
    setTimeout(function() {
    document.getElementById("isapilt").style.backgroundImage="url(munapuder.jpg)"; //sama nagu eelmine aga vahetab tausta alles 5s möödumisel
    }, 5000)
    setTimeout(function() {
    ...
    setTimeout(function() {
        document.getElementById("isapilt").style.backgroundImage="url(kodujuust.jpg)";
    }, 20000)
}
